                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            <label for="post_body" class="col-md-4 control-label">Enter Your Post Here</label>

                            <div class="col-md-6">
                                <textarea id="post_body" type="post_body" class="form-control" name="post_body" value="{{ old('post_body') }}" rows ="8" required></textarea>
